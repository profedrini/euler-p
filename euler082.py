...
Aristas = { (i,j):[(i-1,j), (i,j+1),(i+1,j)] for (i,j) in itertools.product(xrange(1,nRows-1),xrange(1,nCols-1))}

    
for c in xrange(1,nCols-1):
    Aristas[(0,c)]=[(0,c+1), (1,c)]  # Nodos de la fila superior
    Aristas[(nCols-1,c)]=[(nCols-1,c+1), (nCols-2,c)]  # Nodos de la fila inferior
    
for r in xrange(nRows):
    Aristas[(r,0)]=[(r,1)]  # Nodos de la fila izquierda
